...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        Log.d(TAG, "This is clickLemonImage")
    ...
    private fun showSnackbar(): Boolean {
        ...
        Log.d(TAG, "This is showSnackbar")
